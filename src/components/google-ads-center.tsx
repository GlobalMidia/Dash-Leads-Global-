...
import { BarChart3, CalendarDays, LayoutDashboard, LoaderCircle, RefreshCw, Building2, HeartPulse } from "lucide-react";
...
export function GoogleAdsCenter({ user, initialData }: Props) {
  ...
  async function refresh() {
    ...
    try {
      ...
      setData(result.data);
      setNotice(result.data.error ?? `${result.data.accounts.length} contas consultadas.`);
