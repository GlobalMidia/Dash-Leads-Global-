...
import { Activity, AlertTriangle, ArrowRight, Building2, Check, ClipboardList, ExternalLink, HeartPulse, History, LayoutDashboard, LoaderCircle, Pencil, Plus, ShieldCheck, X } from "lucide-react";
