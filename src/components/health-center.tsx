...
import { Activity, AlertTriangle, ArrowRight, BarChart3, Bell, Building2, Check, ClipboardList, ExternalLink, HeartPulse, History, LayoutDashboard, LoaderCircle, Pencil, Plus, RotateCcw, Search, ShieldCheck, X } from "lucide-react";
