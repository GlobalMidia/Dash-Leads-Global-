...
export const DEMO_LEADS: Lead[] = [
  {
    ...
    source: {
      ...
      fileName: "leads-google-julho.csv",
      importedAt: "2026-07-23T12:45:00.000Z",
      importedBy: "marina@globalmidia.digital",
    },
    companyGroupId: "company-norte-engenharia",
    duplicateStatus: "confirmed",
    additionalData: {
      Campanha: "Pesquisa institucional",
      Cidade: "São Paulo",
    },
    history: [
      {
        id: "history-001-group",
        title: "Empresa agrupada sem fusão",
        description:
          "Norte Engenharia foi confirmada como a mesma empresa de outro registro.",
        actor: "Marina Costa",
        actorEmail: "marina@globalmidia.digital",
        occurredAt: "2026-07-23T13:10:00.000Z",
      },
      {
        id: "history-001-import",
        title: "Lead importado",
        description: "Registro importado do arquivo leads-google-julho.csv.",
        actor: "Marina Costa",
        actorEmail: "marina@globalmidia.digital",
        occurredAt: "2026-07-23T12:45:00.000Z",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    rdUuid: null,
    name: "Juliana Costa",
    company: "Costa & Lima Consultoria",
  ...
  },
  {
    ...
    name: "Paula Menezes",
    company: "Norte Engenharia",
    email: "paula@norteengenharia.com.br",
    phone: "(11) 99182-3044",
    origin: "Recomendação",
    enteredAt: "2026-07-12T14:15:00.000Z",
    status: "pending",
    notes: "Contato indicado pelo diretor comercial.",
    updatedAt: "2026-07-23T13:10:00.000Z",
    source: {
      type: "csv",
      label: "Importação CSV",
      fileName: "indicacoes-julho.csv",
      importedAt: "2026-07-23T13:05:00.000Z",
      importedBy: "marina@globalmidia.digital",
    },
    companyGroupId: "company-norte-engenharia",
    duplicateStatus: "confirmed",
    ...
    history: [
      {
        id: "history-017-group",
        title: "Empresa agrupada sem fusão",
        description:
          "O registro foi agrupado com Norte Engenharia, preservando sua origem.",
        actor: "Marina Costa",
        actorEmail: "marina@globalmidia.digital",
        occurredAt: "2026-07-23T13:10:00.000Z",
      },
      {
        id: "history-017-import",
        title: "Lead importado",
        description: "Registro importado do arquivo indicacoes-julho.csv.",
        actor: "Marina Costa",
        actorEmail: "marina@globalmidia.digital",
        occurredAt: "2026-07-23T13:05:00.000Z",
      },
    ],
  },
];
